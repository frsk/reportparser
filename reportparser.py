...
def process(filename):
    ...
    for x in filematch.findall(output.getvalue()):
        if domainmatch.findall(x[0]) or not filewhite.findall(x[1]):
            continue
